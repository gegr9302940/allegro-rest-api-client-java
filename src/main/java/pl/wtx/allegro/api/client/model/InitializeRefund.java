...
public class InitializeRefund {
  ...
  public InitializeRefund() {
  }

  public InitializeRefund payment(@javax.annotation.Nonnull RefundPayment payment) {
  ...
  public InitializeRefund order(@javax.annotation.Nullable RefundOrder order) {
    this.order = order;
    return this;
  }
  ...
  public InitializeRefund commandId(@javax.annotation.Nullable String commandId) {
  ...
  public InitializeRefund reason(@javax.annotation.Nonnull ReasonEnum reason) {
    this.reason = reason;
    return this;
  }
  ...
  public InitializeRefund lineItems(@javax.annotation.Nullable List<RefundLineItem> lineItems) {
  ...
  public InitializeRefund delivery(@javax.annotation.Nullable InitializeRefundDelivery delivery) {
  ...
  public InitializeRefund overpaid(@javax.annotation.Nullable InitializeRefundOverpaid overpaid) {
  ...
  public InitializeRefund surcharges(@javax.annotation.Nullable List<PaymentsSurcharge> surcharges) {
  ...
  public InitializeRefund additionalServices(@javax.annotation.Nullable InitializeRefundAdditionalServices additionalServices) {
  ...
  public InitializeRefund sellerComment(@javax.annotation.Nullable String sellerComment) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.payment, initializeRefund.payment) &&
        Objects.equals(this.order, initializeRefund.order) &&
        Objects.equals(this.commandId, initializeRefund.commandId) &&
        ...
        Objects.equals(this.sellerComment, initializeRefund.sellerComment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(payment, order, commandId, reason, lineItems, delivery, overpaid, surcharges, additionalServices, sellerComment);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InitializeRefund
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InitializeRefund.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InitializeRefund is not found in the empty JSON string", InitializeRefund.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InitializeRefund.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InitializeRefund` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InitializeRefund.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitializeRefund.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitializeRefund' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitializeRefund> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitializeRefund.class));

       return (TypeAdapter<T>) new TypeAdapter<InitializeRefund>() {
           @Override
           public void write(JsonWriter out, InitializeRefund value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InitializeRefund read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InitializeRefund given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InitializeRefund
   * @throws IOException if the JSON string is invalid with respect to InitializeRefund
   */
  public static InitializeRefund fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitializeRefund.class);
  }

  /**
   * Convert an instance of InitializeRefund to an JSON string
   *
   * @return JSON string
   */
