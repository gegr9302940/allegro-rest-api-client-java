...
public class OfferListingDtoV1SellingMode {
  ...
  public OfferListingDtoV1SellingMode() {
  }

  public OfferListingDtoV1SellingMode format(@javax.annotation.Nullable SellingModeFormat format) {
    this.format = format;
    return this;
  }
  ...
  public OfferListingDtoV1SellingMode price(@javax.annotation.Nullable BuyNowPrice price) {
    this.price = price;
    return this;
  }
  ...
  public OfferListingDtoV1SellingMode priceAutomation(@javax.annotation.Nullable PriceAutomation priceAutomation) {
  ...
  public OfferListingDtoV1SellingMode minimalPrice(@javax.annotation.Nullable MinimalPrice minimalPrice) {
  ...
  public OfferListingDtoV1SellingMode startingPrice(@javax.annotation.Nullable StartingPrice startingPrice) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.format, offerListingDtoV1SellingMode.format) &&
        ...
        Objects.equals(this.priceAutomation, offerListingDtoV1SellingMode.priceAutomation) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(format, price, priceAutomation, minimalPrice, startingPrice);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OfferListingDtoV1SellingMode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OfferListingDtoV1SellingMode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OfferListingDtoV1SellingMode is not found in the empty JSON string", OfferListingDtoV1SellingMode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OfferListingDtoV1SellingMode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OfferListingDtoV1SellingMode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OfferListingDtoV1SellingMode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OfferListingDtoV1SellingMode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OfferListingDtoV1SellingMode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OfferListingDtoV1SellingMode.class));

       return (TypeAdapter<T>) new TypeAdapter<OfferListingDtoV1SellingMode>() {
           @Override
           public void write(JsonWriter out, OfferListingDtoV1SellingMode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OfferListingDtoV1SellingMode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OfferListingDtoV1SellingMode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OfferListingDtoV1SellingMode
   * @throws IOException if the JSON string is invalid with respect to OfferListingDtoV1SellingMode
   */
  public static OfferListingDtoV1SellingMode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OfferListingDtoV1SellingMode.class);
  }

  /**
   * Convert an instance of OfferListingDtoV1SellingMode to an JSON string
   *
   * @return JSON string
   */
