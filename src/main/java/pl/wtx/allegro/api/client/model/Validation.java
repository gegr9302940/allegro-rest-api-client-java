...
import pl.wtx.allegro.api.client.model.ValidationError;
import pl.wtx.allegro.api.client.model.ValidationWarning;
...
public class Validation {
  ...
  public Validation errors(@javax.annotation.Nonnull List<ValidationError> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public void setErrors(@javax.annotation.Nonnull List<ValidationError> errors) {
    this.errors = errors;
  }


  public Validation warnings(@javax.annotation.Nullable List<ValidationWarning> warnings) {
    this.warnings = warnings;
    return this;
  }

  public Validation addWarningsItem(ValidationWarning warningsItem) {
  ...
  public void setWarnings(@javax.annotation.Nullable List<ValidationWarning> warnings) {
    this.warnings = warnings;
  }


  public Validation validatedAt(@javax.annotation.Nullable OffsetDateTime validatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, validation.errors) &&
        Objects.equals(this.warnings, validation.warnings) &&
        Objects.equals(this.validatedAt, validation.validatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errors, warnings, validatedAt);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Validation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Validation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("warnings") != null && !jsonObj.get("warnings").isJsonNull()) {
        ...
        if (jsonArraywarnings != null) {
          ...
          for (int i = 0; i < jsonArraywarnings.size(); i++) {
            ValidationWarning.validateJsonElement(jsonArraywarnings.get(i));
          };
        }
      }
  }
