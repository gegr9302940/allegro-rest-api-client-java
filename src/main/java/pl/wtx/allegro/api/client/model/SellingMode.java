...
public class SellingMode {
  ...
  public SellingMode format(@javax.annotation.Nullable SellingModeFormat format) {
    this.format = format;
    return this;
  }
  ...
  public SellingMode price(@javax.annotation.Nullable BuyNowPrice price) {
    this.price = price;
    return this;
  }
  ...
  public SellingMode minimalPrice(@javax.annotation.Nullable MinimalPrice minimalPrice) {
  ...
  public SellingMode startingPrice(@javax.annotation.Nullable StartingPrice startingPrice) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to SellingMode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SellingMode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SellingMode is not found in the empty JSON string", SellingMode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SellingMode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SellingMode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SellingMode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SellingMode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SellingMode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SellingMode.class));

       return (TypeAdapter<T>) new TypeAdapter<SellingMode>() {
           @Override
           public void write(JsonWriter out, SellingMode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SellingMode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SellingMode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SellingMode
   * @throws IOException if the JSON string is invalid with respect to SellingMode
   */
  public static SellingMode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SellingMode.class);
  }

  /**
   * Convert an instance of SellingMode to an JSON string
   *
   * @return JSON string
   */
