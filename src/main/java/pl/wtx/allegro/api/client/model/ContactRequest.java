...
import pl.wtx.allegro.api.client.model.EmailRequest;
import pl.wtx.allegro.api.client.model.PhonesRequest;
...
public class ContactRequest {
  ...
  @javax.annotation.Nullable
  private List<PhonesRequest> phones = new ArrayList<>();

  public ContactRequest() {
  }

  public ContactRequest name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ContactRequest emails(@javax.annotation.Nullable List<EmailRequest> emails) {
    this.emails = emails;
    return this;
  }
  ...
  public void setEmails(@javax.annotation.Nullable List<EmailRequest> emails) {
    this.emails = emails;
  }


  public ContactRequest phones(@javax.annotation.Nullable List<PhonesRequest> phones) {
    this.phones = phones;
    return this;
  }
  ...
  public void setPhones(@javax.annotation.Nullable List<PhonesRequest> phones) {
    this.phones = phones;
  }
      ...
      if (jsonObj.get("emails") != null && !jsonObj.get("emails").isJsonNull()) {
        ...
        if (jsonArrayemails != null) {
          ...
          for (int i = 0; i < jsonArrayemails.size(); i++) {
            EmailRequest.validateJsonElement(jsonArrayemails.get(i));
          };
        }
      }
      if (jsonObj.get("phones") != null && !jsonObj.get("phones").isJsonNull()) {
        ...
        if (jsonArrayphones != null) {
          ...
          for (int i = 0; i < jsonArrayphones.size(); i++) {
            PhonesRequest.validateJsonElement(jsonArrayphones.get(i));
          };
        }
      }
  }
