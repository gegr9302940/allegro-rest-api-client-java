...
import pl.wtx.allegro.api.client.model.OrderOffersInner;
...
public class Order {
  ...
  @javax.annotation.Nonnull
  private List<OrderOffersInner> offers = new ArrayList<>();
  ...
  public Order offers(@javax.annotation.Nonnull List<OrderOffersInner> offers) {
    this.offers = offers;
    return this;
  }
  ...
  public void setOffers(@javax.annotation.Nonnull List<OrderOffersInner> offers) {
    this.offers = offers;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayoffers.size(); i++) {
        OrderOffersInner.validateJsonElement(jsonArrayoffers.get(i));
      };
  }
