...
public class Parameter {
  ...
  public Parameter id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public Parameter rangeValue(@javax.annotation.Nullable ParameterRangeValue rangeValue) {
  ...
  public Parameter values(@javax.annotation.Nullable List<String> values) {
    this.values = values;
    return this;
  }
  ...
  public Parameter valuesIds(@javax.annotation.Nullable List<String> valuesIds) {
