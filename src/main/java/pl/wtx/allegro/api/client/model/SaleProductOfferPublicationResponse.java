...
import pl.wtx.allegro.api.client.model.SaleProductOfferPublicationMarketplacesResponse;
...
public class SaleProductOfferPublicationResponse {
  ...
  @javax.annotation.Nullable
  private SaleProductOfferPublicationMarketplacesResponse marketplaces;

  public SaleProductOfferPublicationResponse() {
  }
  ...
  public SaleProductOfferPublicationResponse duration(@javax.annotation.Nullable String duration) {
  ...
  public SaleProductOfferPublicationResponse startingAt(@javax.annotation.Nullable OffsetDateTime startingAt) {
  ...
  public SaleProductOfferPublicationResponse status(@javax.annotation.Nullable OfferStatus status) {
    this.status = status;
    return this;
  }
  ...
  public SaleProductOfferPublicationResponse republish(@javax.annotation.Nullable Boolean republish) {
  ...
  public SaleProductOfferPublicationResponse endingAt(@javax.annotation.Nullable OffsetDateTime endingAt) {
  ...
  public SaleProductOfferPublicationResponse marketplaces(@javax.annotation.Nullable SaleProductOfferPublicationMarketplacesResponse marketplaces) {
   ...
   */
  @javax.annotation.Nullable
  public SaleProductOfferPublicationMarketplacesResponse getMarketplaces() {
    return marketplaces;
  }

  public void setMarketplaces(@javax.annotation.Nullable SaleProductOfferPublicationMarketplacesResponse marketplaces) {
    this.marketplaces = marketplaces;
  }
  ...
  public boolean equals(Object o) {
    ...
    SaleProductOfferPublicationResponse saleProductOfferPublicationResponse = (SaleProductOfferPublicationResponse) o;
    return Objects.equals(this.duration, saleProductOfferPublicationResponse.duration) &&
        Objects.equals(this.startingAt, saleProductOfferPublicationResponse.startingAt) &&
        Objects.equals(this.status, saleProductOfferPublicationResponse.status) &&
        Objects.equals(this.republish, saleProductOfferPublicationResponse.republish) &&
        Objects.equals(this.endingAt, saleProductOfferPublicationResponse.endingAt) &&
        Objects.equals(this.endedBy, saleProductOfferPublicationResponse.endedBy) &&
        Objects.equals(this.marketplaces, saleProductOfferPublicationResponse.marketplaces);
  }

  @Override
  public int hashCode() {
    return Objects.hash(duration, startingAt, status, republish, endingAt, endedBy, marketplaces);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SaleProductOfferPublicationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SaleProductOfferPublicationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SaleProductOfferPublicationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SaleProductOfferPublicationResponse is not found in the empty JSON string", SaleProductOfferPublicationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SaleProductOfferPublicationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SaleProductOfferPublicationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("marketplaces") != null && !jsonObj.get("marketplaces").isJsonNull()) {
        SaleProductOfferPublicationMarketplacesResponse.validateJsonElement(jsonObj.get("marketplaces"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SaleProductOfferPublicationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SaleProductOfferPublicationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SaleProductOfferPublicationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SaleProductOfferPublicationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SaleProductOfferPublicationResponse>() {
           @Override
           public void write(JsonWriter out, SaleProductOfferPublicationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SaleProductOfferPublicationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SaleProductOfferPublicationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SaleProductOfferPublicationResponse
   * @throws IOException if the JSON string is invalid with respect to SaleProductOfferPublicationResponse
   */
  public static SaleProductOfferPublicationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SaleProductOfferPublicationResponse.class);
  }

  /**
   * Convert an instance of SaleProductOfferPublicationResponse to an JSON string
   *
   * @return JSON string
   */
