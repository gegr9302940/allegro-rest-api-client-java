...
public class SaleProductOfferRequestV1AllOfProductSet {
  ...
  public SaleProductOfferRequestV1AllOfProductSet() {
  }

  public SaleProductOfferRequestV1AllOfProductSet product(@javax.annotation.Nullable ProductOffer product) {
  ...
  public SaleProductOfferRequestV1AllOfProductSet quantity(@javax.annotation.Nullable ProductSetElementQuantityQuantity quantity) {
  ...
  public SaleProductOfferRequestV1AllOfProductSet responsiblePerson(@javax.annotation.Nullable ProductSetElementResponsiblePersonRequestResponsiblePerson responsiblePerson) {
  ...
  public SaleProductOfferRequestV1AllOfProductSet responsibleProducer(@javax.annotation.Nullable ProductSetElementResponsibleProducerRequest responsibleProducer) {
  ...
  public SaleProductOfferRequestV1AllOfProductSet safetyInformation(@javax.annotation.Nullable ProductSetElementSafetyInformation safetyInformation) {
  ...
  public SaleProductOfferRequestV1AllOfProductSet marketedBeforeGPSRObligation(@javax.annotation.Nullable Boolean marketedBeforeGPSRObligation) {
  ...
  public boolean equals(Object o) {
    ...
    SaleProductOfferRequestV1AllOfProductSet saleProductOfferRequestV1AllOfProductSet = (SaleProductOfferRequestV1AllOfProductSet) o;
    return Objects.equals(this.product, saleProductOfferRequestV1AllOfProductSet.product) &&
        Objects.equals(this.quantity, saleProductOfferRequestV1AllOfProductSet.quantity) &&
        Objects.equals(this.responsiblePerson, saleProductOfferRequestV1AllOfProductSet.responsiblePerson) &&
        Objects.equals(this.responsibleProducer, saleProductOfferRequestV1AllOfProductSet.responsibleProducer) &&
        Objects.equals(this.safetyInformation, saleProductOfferRequestV1AllOfProductSet.safetyInformation) &&
        Objects.equals(this.marketedBeforeGPSRObligation, saleProductOfferRequestV1AllOfProductSet.marketedBeforeGPSRObligation);
  }
  ...
  public String toString() {
    ...
    sb.append("class SaleProductOfferRequestV1AllOfProductSet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SaleProductOfferRequestV1AllOfProductSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SaleProductOfferRequestV1AllOfProductSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SaleProductOfferRequestV1AllOfProductSet is not found in the empty JSON string", SaleProductOfferRequestV1AllOfProductSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SaleProductOfferRequestV1AllOfProductSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SaleProductOfferRequestV1AllOfProductSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SaleProductOfferRequestV1AllOfProductSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SaleProductOfferRequestV1AllOfProductSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SaleProductOfferRequestV1AllOfProductSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SaleProductOfferRequestV1AllOfProductSet.class));

       return (TypeAdapter<T>) new TypeAdapter<SaleProductOfferRequestV1AllOfProductSet>() {
           @Override
           public void write(JsonWriter out, SaleProductOfferRequestV1AllOfProductSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SaleProductOfferRequestV1AllOfProductSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SaleProductOfferRequestV1AllOfProductSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SaleProductOfferRequestV1AllOfProductSet
   * @throws IOException if the JSON string is invalid with respect to SaleProductOfferRequestV1AllOfProductSet
   */
  public static SaleProductOfferRequestV1AllOfProductSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SaleProductOfferRequestV1AllOfProductSet.class);
  }

  /**
   * Convert an instance of SaleProductOfferRequestV1AllOfProductSet to an JSON string
   *
   * @return JSON string
   */
